...
var IncrementAction = 'Counter INC';
var DecrementAction = 'Counter DEC';
...
var CounterModifierComponent = /** @class */ (function () {
    function CounterModifierComponent(store) {
        this.store = store;
    }
    CounterModifierComponent.prototype.incrementCounter = function () {
        this.store.dispatch(new _actions_counter_actions__WEBPACK_IMPORTED_MODULE_3__["Increment"]());
    };
    CounterModifierComponent.prototype.deccrementCounter = function () {
        this.store.dispatch(new _actions_counter_actions__WEBPACK_IMPORTED_MODULE_3__["Decrement"]());
    };
    CounterModifierComponent.prototype.ngOnInit = function () {
    };
    CounterModifierComponent.ctorParameters = function () { return [
    ...
    return CounterModifierComponent;
}());
...
function reducer(state, action) {
    if (state === void 0) { state = InitialCounter; }
    switch (action.type) {
